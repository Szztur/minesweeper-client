...
public class BoardService {
    ...
    public BoardService(ServerService serverConnector, BoardGame boardGame) {
    ...
    public CellService selectCell(int row, int column) {
        CellService response = serverConnector.selectCell(row, column);
            ...
            while (playing) {
                ...
                try {
                    if (operation == 2) {
                        ...
                        CellService response = selectCell(row, column);
